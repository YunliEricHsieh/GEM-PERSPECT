...
combined_plot <- gridExtra::grid.arrange(
  violin_plot,
  plot_recall_vs_count(f_recall_rate, 'b. Reaction-gene pairs point of view', 
                       "Recall Rate", "Number of reaction-gene pairs", "Threshold"),
  plot_recall_vs_count(s_recall_rate, 'c. Reaction center point of view', 
                       "Recall Rate", "Number of reactions", "Threshold"),
  plot_recall_vs_count(t_recall_rate, 'd. Gene center point of view', 
