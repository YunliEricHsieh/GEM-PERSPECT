...
f_recall_rate <- list(
  alpha001 = data.frame(Type = character(), Threshold = character(), Recall = numeric(), N_rxns = numeric(), stringsAsFactors = FALSE),
  alpha005 = data.frame(Type = character(), Threshold = character(), Recall = numeric(), N_rxns = numeric(), stringsAsFactors = FALSE),
  alpha01 = data.frame(Type = character(), Threshold = character(), Recall = numeric(), N_rxns = numeric(), stringsAsFactors = FALSE)
)
...
# Combine the plots
library(gridExtra)
alpha001 <- gridExtra::grid.arrange(
  plot_recall_vs_count(f_recall_rate$alpha001, 'Reaction-gene pair perspective', 
                       "Recall Rate", "Number of reaction-gene pairs", "", "alpha = 0.01"),
  plot_recall_vs_count(s_recall_rate$alpha001, 'Reaction-centric perspective', 
                       "Recall Rate", "Number of reactions", "", "alpha = 0.01"),
  plot_recall_vs_count(t_recall_rate$alpha001, 'Gene-centric perspective', 
                       "Recall Rate", "Number of genes", "", "alpha = 0.01"),
  ncol = 3
)
alpha005 <- gridExtra::grid.arrange(
  plot_recall_vs_count(f_recall_rate$alpha005, '', 
                       "Recall Rate", "Number of reaction-gene pairs", "", "alpha = 0.05"),
  plot_recall_vs_count(s_recall_rate$alpha005, '', 
                       "Recall Rate", "Number of reactions", "", "alpha = 0.05"),
  plot_recall_vs_count(t_recall_rate$alpha005, '', 
                       "Recall Rate", "Number of genes", "", "alpha = 0.05"),
  ncol = 3
)
alpha01 <- gridExtra::grid.arrange(
  plot_recall_vs_count(f_recall_rate$alpha01, '', 
                       "Recall Rate", "Number of reaction-gene pairs", "Threshold", "alpha = 0.1"),
  plot_recall_vs_count(s_recall_rate$alpha01, '', 
                       "Recall Rate", "Number of reactions", "Threshold", "alpha = 0.1"),
  plot_recall_vs_count(t_recall_rate$alpha01, '', 
                       "Recall Rate", "Number of genes", "Threshold","alpha = 0.1"),
  ncol = 3
)
...
ggsave("Results/figures/Sup Fig 2.svg", combined_plot, width = 12, height = 13)
